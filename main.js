...
function setupRealtimeListeners() {
    ...
    onSnapshot(salesCollection, (snapshot) => {
        ...
        // updateDailyTotals() se llama al final de la función para asegurar que todos los listeners estén listos.
    ...
    // FIX PRINCIPAL: Ejecución inicial de la lógica de totales.
    // Esto asegura que la caja se cargue con los datos del día al reiniciar la página.
    updateDailyTotals();
}
